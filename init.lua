...
-- minetest.chat_send_player(puncher_name, "data: "..minetest.serialize(  travelnet.targets ));
      ...
      meta:set_string("formspec",
                            ...
                            "field[0.3,4.6;6,0.7;station_network;Assign to Network:;"..(station_network or "?").."]"..
                            "field[0.3,5.6;6,0.7;owner;Owned by:;"..(owner_name or "?").."]"..
...
travelnet.on_receive_fields = function(pos, formname, fields, player)
   ...
   if( node2 ~= nil and node2.name ~= 'ignore' and node2.name ~= 'travelnet:elevator' and minetest.get_item_group(node2, "travelnetbox") ~= 0) then
  --  and  node2.name ~= 'travelnet:travelnet_public_blue' and node2.name ~= 'travelnet:travelnet_public_green' and node2.name ~= 'travelnet:travelnet_public_violet' and node2.name ~= 'travelnet:travelnet_public_yellow'
  --  and node2.name ~= "travelnet:protected_travelnet_blue" and node2.name ~= "travelnet:protected_travelnet_green" and node2.name ~= "travelnet:protected_travelnet_violet" and node2.name ~= "travelnet:protected_travelnet_yellow"
  --  and node2.name ~= "travelnet:locked_travelnet_blue" and node2.name ~= "travelnet:locked_travelnet_green" and node2.name ~= "travelnet:locked_travelnet_violet" and node2.name ~= "travelnet:locked_travelnet_yellow") then
